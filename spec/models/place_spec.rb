...
describe Place do
  ...
  describe "when finding the closest place to a point" do
    ...
    context "and there are no places in the desired range" do
      it "finds nothing" do
        Factory(:place, longitude: -4.06390, latitude: 5.34670, :category => "Pubs")
    ...
    context "and there is a single place in the desired range" do
      it "finds the single place" do
        place = Factory(:place, longitude: -4.06390, latitude: 5.34670, :category => "Pubs")
    ...
    context "and there are multiple places in the desired range" do
      it "orders the places by distance from the original coordinates" do
        Factory(:place, longitude: -4.06395, latitude: 5.34675, :category => "Pubs", :name => "King Tavern")
        Factory(:place, longitude: -4.06390, latitude: 5.34670, :category => "Pubs", :name => "Duke of Gloucester")
